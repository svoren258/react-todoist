...
const App: React.FC = () => {
  ...
  const parsedState = localStorageState ? JSON.parse(localStorageState) : undefined;
  ...
  return (
    <div className="main-container">
      ...
      <input className="input-container" type="text" onKeyDown={handleKeyDown} ref={inputRef} placeholder="Type here"/>
